...
namespace PrimerParcial.Controllers
{
    public class PaisesController : Controller
    {
        ...
        public PaisesController(ParcialDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Paises paises)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Paises paises)
        {
            if (id != paises.Id)
            {
                return NotFound();
