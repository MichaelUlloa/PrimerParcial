...
namespace PrimerParcial.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public EmpleadosController(ParcialDbContext context)
        {
            _context = context;
        }
        ...
        {
            var parcialDbContext = _context.Empleados.Include(e => e.Empresa).Include(e => e.JobTitle);
        ...
        {
            ViewData["EmpresaId"] = new SelectList(_context.Empresas, "Id", "Name");
            ViewData["JobTitleId"] = new SelectList(_context.PuestosTrabajo, "Id", "Name");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateOfBirth,HiredDate,JobTitleId,EmpresaId")] Empleados empleados)
        {
            if (id != empleados.Id)
            {
                return NotFound();
