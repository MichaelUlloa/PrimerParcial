...
namespace PrimerParcial.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(ParcialDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Vendedores vendedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Vendedores vendedores)
        {
            if (id != vendedores.Id)
            {
                return NotFound();
